...
<body class="w-full h-screen overflow-hidden">
    ...
    <div id="country-info-modal" class="modal">
        <div class="modal-content">
            <div class="w-full lg:w-[500px] overflow-hidden bg-white bg-opacity-90">
                ...
                <div class="bg-slate-700 text-white text-center p-2">Country Information</div>
    ...
    <div id="weather-info-modal" class="modal">
        <div class="modal-content">
            <div class="w-full lg:w-[500px] overflow-hidden bg-white bg-opacity-90">
                <span class="close">&times;</span>
                <div class="bg-slate-700 text-white text-center p-2">Current Weather</div>
    ...
    <div id="currency-info-modal" class="modal">
        <div class="modal-content">
            <div class="w-full lg:w-[500px] overflow-hidden bg-white bg-opacity-90">
                <span class="close">&times;</span>
                <div class="bg-slate-700 text-white text-center p-2">Currency Converter</div>
                <div class="content p-5"></div>
            </div>
        </div>
    </div>
    ...
    <div id="timezone-info-modal" class="modal">
        <div class="modal-content">
            <div class="w-full lg:w-[500px] overflow-hidden bg-white bg-opacity-90">
                <span class="close">&times;</span>
                <div class="bg-slate-700 text-white text-center p-2">Time Zone Information </div>
                <div class="content"></div>
            </div>
        </div>
    </div>
    ...
    <div id="wiki-info-modal" class="modal">
        <div class="modal-content">
            <div class="w-full lg:w-[500px] overflow-hidden bg-white bg-opacity-90">
                <span class="close">&times;</span>
                <div class="bg-slate-700 text-white text-center p-2">Wikipedia Information </div>
                <div class="content"></div>
            </div>
        </div>
    </div>
